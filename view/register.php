    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <div class="form-group">
                    <label class="form-label" for="emailverify">Имя пользователя</label>
                    <input type="text" id="emailverify" name="username" class="form-control" placeholder="Имя пользователя"
                           required>
                </div>
                <div class="form-group">
